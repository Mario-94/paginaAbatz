        ...
        <div className="acercaDeNosotros">
          <div className="valores">
            ...
            <ul>
              ...
              <li>
                <strong>honradez:</strong> basamos nuestros actor en la
                sinceridad de pensamiento y acción. El respeto a las cosas
                ajeanas y la no intervencion en la vida y asuntos personales de
                nuestros compañeros.
              </li>
              <li>
              ...
              <li>
                ...
                lo que llevamos a cabo ne nuestro actuar y pensar, con el
              ...
              <li>
                ...
                podemos dar la gracias por trabajar en equipo y pertenecer a un
                a empresa que permita tener un desarrollo laboral continuo
              </li>
              <li>
                <strong>respeto por el derecho:</strong> Tomar en cuenta a todos
                nuetros compañeros, rechazar cualquier propósito de ofensa o
                agresion, tenemos la convicción de escuchar y aceptar puntos de
                vista diferentes a alos nuetros.
              </li>
              <li>
